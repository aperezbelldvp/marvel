...
export class Convert {
  public static toHeroCharacter(json: string): HeroModel {
    return cast(JSON.parse(json), r('HeroCharacter'));
  }

  public static heroCharacterToJson(value: HeroModel): string {
    return JSON.stringify(uncast(value, r('HeroCharacter')), null, 2);
  }
}
...
const typeMap: any = {
  ...
  ItemType: ['cover', '', 'interiorStory'],
  Extension: ['gif', 'jpg'],
  URLType: ['comiclink', 'detail', 'wiki'],
};
